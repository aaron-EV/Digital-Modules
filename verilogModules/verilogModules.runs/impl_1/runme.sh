...
HD_PWD='C:/Users/aaron/Desktop/git_verilogProjects/verilogModules/verilogModules.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log halfAdder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source halfAdder.tcl -notrace
