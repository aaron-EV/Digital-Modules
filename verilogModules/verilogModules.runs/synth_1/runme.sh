...
HD_PWD='C:/Users/aaron/Desktop/git_verilogProjects/verilogModules/verilogModules.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log halfAdder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source halfAdder.tcl
